...
import home from '@/public/images/hero-project.webp'
        ...
        <div className="overflow-hidden">
            <MotionSection className="welcome-div relative w-full h-dvh  mb-5 lg:mb-10 ">
                ...
                >
                    <motion.div
                        variants={itemVariants}
                        className="text-black font-bold text-2xl md:text-3xl lg:text-4xl  max-w-[70vw] lg:max-w-3xl"
                    >
                        <p className="leading-[1.5] md:leading-[1.2]">Your Vision, Our Expertise See How We Bring Spaces to Life</p>
                    </motion.div>
                </motion.div>
            </MotionSection>
